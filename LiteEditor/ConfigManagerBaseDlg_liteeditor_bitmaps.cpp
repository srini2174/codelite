...
void wxC774CInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/ConfigManagerBaseDlg_liteeditor_bitmaps.cpp$C__src_codelite_LiteEditor_ConfigManagerBaseDlg_liteeditor_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/ConfigManagerBaseDlg_liteeditor_bitmaps.cpp$C__src_codelite_LiteEditor_ConfigManagerBaseDlg_liteeditor_bitmaps.xrc"));
}
