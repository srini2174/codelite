...
void wxCrafterFrb2RoInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/breakpoint_dlg_liteeditor_bitmaps.cpp$_home_david_devel_git_CODELITE_LiteEditor_breakpoint_dlg_liteeditor_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/breakpoint_dlg_liteeditor_bitmaps.cpp$_home_david_devel_git_CODELITE_LiteEditor_breakpoint_dlg_liteeditor_bitmaps.xrc"));
}
